...
Find places where the same fact is stated in more than one file, in violation of the repo's
golden rule: every fact lives in exactly one canonical file; every other mention is a link.
