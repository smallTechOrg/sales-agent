...
from zer0.api.companies import router as companies_router
...
from zer0.api.people import router as people_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(people_router, prefix=_PREFIX)
